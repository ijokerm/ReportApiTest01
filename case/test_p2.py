...
class Test_Api(unittest.TestCase):
    ...
    def test_api(self,items):
        ...
        try:
            ...
            Test_Api.excel.write_excel(config.CASE_FILE,'p2',items['case_id']+1,10,res.status_code)
            #   如果断言成功，则在第10列写入测试结果‘pass’，否则写入‘fail’
            Test_Api.excel.write_excel(config.CASE_FILE,'p2',items['case_id']+1,11,result)
